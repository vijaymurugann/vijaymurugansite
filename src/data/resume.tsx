...
export const DATA = {
  ...
  summary:
    "A Blockchain Web Developer based in India who worked for Canada, UK, Singapore & Dubai clients.I began my tech journey at 16(Currently 23), teaching myself to code and building software applications. later pursuing a BSc in computer science. My path led me to freelancing in web & blockchain development, where I've worked on more than 26+ projects, spoken at meetups, and found inspiration in a vibrant community.",
  avatarUrl: "/me.png",
  skills: [
    "React",
    "Next.js",
